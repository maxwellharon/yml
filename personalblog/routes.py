...
from personalblog import app, db, bcrypt
...
def new_post():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('home'))
    return render_template('create_post.html', title='Create a new Business',
                           form=form, legend='Create a new Business')
